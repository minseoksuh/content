...
> **Note:** It is important to note that inline elements such as `<p>` **continues the [inline formatting context](https://www.w3.org/TR/css-display-3/#inline-formatting-context)** of its **block container** and does not establish an independent formatting context. Thus, they do not serve as a containing block in the case above.
